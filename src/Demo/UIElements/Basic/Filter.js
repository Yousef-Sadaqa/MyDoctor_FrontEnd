...
export default class className extends React.Component {
  ...
  componentDidMount() {
    let { specialty } = this.props.match.params
    specialty = specialty.replace(/-/ig, ' ')
    const { token } = localStorage
    const endPoint = `http://localhost:8000/Search/getDoctors/${specialty}`
