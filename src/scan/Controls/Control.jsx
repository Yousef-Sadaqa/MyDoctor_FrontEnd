...
const herePlaces = {
  0: { name: 'pharmacy', color: 'red' },
  1: { name: 'hospital', color: 'orange' },
  2: { name: 'hospital-health-care-facility', color: 'blue' },
    ...
    return (
      <div>
        <Segment style={segmentStyle}>
          <div>
            <span>
              <Header as="h4">DBScan Find the nearest Doctor & pharmacy & hospital </Header>
              
            </span>
          </div>
          <Header as="h5">Search settings</Header>
